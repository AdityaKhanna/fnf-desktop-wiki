Bitbucket is kind enough to give us a guide to how to create and use the wiki. Here is that guide 
...
```
$ git clone https://pintoubuntu@bitbucket.org/pintoubuntu/fnf-web-app.git/wiki
```
